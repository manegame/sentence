...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("mud"), bytes16("Story")))
);
...
library Story {
  ...
  function setPeriodEndsBlock(bytes32 key, uint256 periodEndsBlock) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((periodEndsBlock)), _fieldLayout);
  }
  ...
  function _setPeriodEndsBlock(bytes32 key, uint256 periodEndsBlock) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((periodEndsBlock)), _fieldLayout);
  }
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (StoryData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
